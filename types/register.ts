...
export type RegisterAction =
	| { type: 'UPDATE_FIELD'; field: keyof FormType; value: any }
	| { type: 'VALIDATE_FIELD'; field: keyof FormType; error: string | null }
...
export const registerActions = {
	updateField: (field: keyof FormType, value: any): RegisterAction => ({
		type: 'UPDATE_FIELD',
		field,
		value,
	}),
